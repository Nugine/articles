...
[Unsafe Rust 随堂小测（二）](./2022/06/unsafe-rust-test-2/README.md)
...
[校验十六进制字符的奇技淫巧](./2021/11/hex-trick/README.md)
...
**作者保留一切权利**。如需转载、修改或商用，请联系作者获取单独授权。

向本仓库发出 Pull Request 时，即默认您将相关修改的**著作权**无条件移交予本仓库的所有者，本仓库所有者有权以任意方式使用该内容。

本仓库内容将再次发布于知乎专栏《[Rust 日常](https://www.zhihu.com/column/c_1115180704186613760)》。您可以按照知乎协议使用发布于该专栏的所有内容。
